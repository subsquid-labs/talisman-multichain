module.exports = class Init1654758341551 {
  name = 'Init1654758341551'

  async up(db) {
    await db.query(`CREATE TABLE "transactions" ("id" character varying NOT NULL, "order" text NOT NULL, "chain_id" text NOT NULL, "block_number" numeric NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "section" text NOT NULL, "method" text NOT NULL, "related_addresses" text array NOT NULL, CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`)
