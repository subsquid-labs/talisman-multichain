module.exports = class Init1654267702328 {
  name = 'Init1654267702328'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "chain_info" ("id" character varying NOT NULL, "url" text NOT NULL, "latest_block" numeric NOT NULL, CONSTRAINT "PK_1b82ce2acbc16bfc7f84bfdc8ff" PRIMARY KEY ("id"))`)
