module.exports = class Init1655729017335 {
  name = 'Init1655729017335'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "transaction" ("id" character varying NOT NULL, "extrinsic_id" text NOT NULL, "chain_id" character varying NOT NULL, "block_number" numeric NOT NULL, "index_in_block" numeric NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "section" text NOT NULL, "method" text NOT NULL, "name" text NOT NULL, "signer" text NOT NULL, "related_addresses" text array NOT NULL, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`)
