module.exports = class Init1655387017907 {
  name = 'Init1655387017907'

  async up(db) {
    await db.query(`CREATE TABLE "chain" ("id" character varying NOT NULL, "url" text NOT NULL, "starting_block" numeric NOT NULL, "latest_block" numeric NOT NULL, "hash" text NOT NULL, "created_at" numeric NOT NULL, "updated_at" numeric NOT NULL, CONSTRAINT "PK_8e273aafae283b886672c952ecd" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "transaction" ("id" character varying NOT NULL, "chain_id" character varying NOT NULL, "block_number" numeric NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "section" text NOT NULL, "method" text NOT NULL, "name" text NOT NULL, "signer" text NOT NULL, "related_addresses" text array NOT NULL, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`)
